...
\restrict TRHBh15b0IxaTrZg0UFuxfkiHIo2dhzp0A1hD9ceoGfavdUw7OOva7m5qKftAHc
...
--
-- Name: company_site_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: company_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: currency_rate_tab; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.currency_rate_tab (
    company character varying(80) NOT NULL,
    currency_type character varying(40) NOT NULL,
    currency_code character varying(12) NOT NULL,
    valid_from date NOT NULL,
    currency_rate numeric(22,6),
    ref_currency_code character varying(12),
    rowversion timestamp without time zone,
    rowkey character varying(200)
);
...
--
-- Name: customer_order_line_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: customer_order_tab; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.customer_order_tab (
    ...
    rowversion numeric(22,0) DEFAULT 1 NOT NULL,
    rowkey character varying(200) NOT NULL,
    paid_amount numeric(25,2) DEFAULT 0.00
);
...
--
-- Name: prod_structure_head_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: prod_structure_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: routing_head_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: routing_operation_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: shop_material_alloc_tab; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shop_material_alloc_tab (
    order_no character varying(48) NOT NULL,
    line_item_no numeric(22,0) NOT NULL,
    part_no character varying(100) NOT NULL,
    contract character varying(20) NOT NULL,
    operation_no numeric(22,0),
    create_date date,
    qty_assigned numeric(22,0),
    qty_issued numeric(22,0),
    qty_per_assembly numeric(22,0),
    qty_required numeric(22,0),
    note_text character varying(4000),
    activity_seq numeric(22,0),
    project_id character varying(40),
    catch_qty_issued numeric(22,0),
    qty_scrapped_component numeric(22,0),
    rowversion numeric(22,0),
    rowkey character varying(200),
    rowstate character varying(80)
);
...
--
-- Name: shop_ord_tab; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shop_ord_tab (
    order_no character varying(48) NOT NULL,
    ...
    need_date date,
    complete_date date,
    revised_qty_due numeric(22,0),
    qty_complete numeric(22,0),
    operation_scrapped numeric(22,0),
    note_text character varying(4000),
    customer_order_no character varying(48),
    customer_line_no character varying(16),
    customer_rel_no character varying(16),
    customer_line_item_no numeric(22,0),
    customer_no character varying(80),
    project_id character varying(40),
    activity_seq numeric(22,0),
    owning_customer_no character varying(80),
    created_by character varying(120),
    rowversion numeric(22,0),
    rowkey character varying(200),
    rowstate character varying(80),
    planner_id character varying(100) DEFAULT NULL::character varying
);
...
--
-- Name: work_center_tab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Data for Name: company_site_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: company_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
01	Test Firması	2026-02-07	111111111111111111	tr	\N	\N	TR	admin	TR	1	e25f3a6f-14e4-4723-85d5-d95758e13bc8
\.


--
-- Data for Name: currency_rate_tab; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.currency_rate_tab (company, currency_type, currency_code, valid_from, currency_rate, ref_currency_code, rowversion, rowkey) FROM stdin;
\.
...
000001	deneme	111111112	as	TR	company	regular	no_limit	credit_limit	tr	System	System	2026-02-07	\N	2	ec1f957d-ed03-4e13-a545-93cc1840d5e9	\N
\.


--
-- Data for Name: customer_order_line_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
TST	SO10012	001	001	001	AP-001	AP-001	IBB-PROFILE-01	Alüminyum 20x20mm Kare Profil - 6 metre	STANDARD	30.00	30.00	120.75	142.49	120.75	142.49	MT	MT	MT	1.00	0.00	0.00	1.00	1.00	2026-02-05	2026-02-18	\N	\N	\N	2026-02-20	\N	\N	\N	1	ORDER	STANDARD	KGV	Kamu binası tabela çerçevesi	CUST018	\N	KARGO	DDP	COMPANY	1	PROJ-IBB-001	1	N	ACTIVE	3	f395812d-9bef-40dc-bf80-3a50cbfa3712
TST	SO10012	001	002	002	ACR-003	ACR-003	IBB-PANEL-02	Akrilik Levha 2mm Kalınlık - 1220x2440mm - Kırmızı	STANDARD	15.00	15.00	211.05	249.04	211.05	249.04	M2	M2	M2	1.00	0.00	0.00	1.00	1.00	2026-02-05	2026-02-18	\N	\N	\N	2026-02-20	\N	\N	\N	2	ORDER	STANDARD	KGV	Yönlendirme panoları	CUST018	\N	KARGO	DDP	COMPANY	2	PROJ-IBB-001	2	N	ACTIVE	3	3da09b6a-df57-4337-bc46-e2fe453919e10
TST	SO05742	01	001	001	AP-001	AP-001	\N	Alüminyum 20x20mm Kare Profil - 6 metre	STANDARD	10.00	\N	\N	\N	10.00	\N	\N	\N	\N	\N	\N	\N	1.00	\N	2026-02-06	\N	\N	\N	\N	\N	\N	\N	\N	\N	ORDER	\N	\N	\N	CUST018	\N	\N	\N	\N	\N	\N	\N	\N	\N	1	ddcd4d14-ac3a-4cb5-abf8-d0d98fa44153
TST	SO04476	01	001	001	PART06002	PART06002	\N	BASKILI ROZET	STANDARD	1000.00	\N	\N	\N	100.00	\N	\N	\N	\N	\N	\N	\N	1.00	\N	2026-02-06	\N	\N	\N	\N	\N	\N	\N	\N	\N	ORDER	\N	\N	\N	CUST005	\N	\N	\N	\N	\N	\N	\N	\N	ACTIVE	4	92d8b25d-dec1-4b0f-bca9-45510bd4a00d
\.


--
-- Data for Name: customer_order_tab; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.customer_order_tab (company, order_no, contract, customer_no, customer_po_no, date_entered, wanted_delivery_date, pay_term_base_date, currency_code, pay_term_id, delivery_terms, ship_via_code, delivery_country_code, order_id, authorize_code, salesman_code, bill_addr_no, ship_addr_no, internal_po_no, note_text, rowstate, created_by, rowversion, rowkey, paid_amount) FROM stdin;
TST	SO10002	001	CUST004	ANR-2456	2026-01-18	2026-01-28	2026-02-05	TRY	15GÜN	EXW	KARGO	TR	ORD002	AUTH002	SALES02	1	2	INT-ANR-001	Neon tabela ve montaj hizmeti	ACTIVE	admin	2	f395812d-9bef-40dc-bf80-3a50cbfa3707	0.00
TST	SO10003	001	CUST005	IAT-TS-789	2026-01-20	2026-01-30	2026-02-15	TRY	30GÜN	FCA	DENIZ	TR	ORD003	AUTH003	SALES01	1	1	INT-IAT-001	Toptan LED tabela siparişi	ACTIVE	admin	2	3da09b6a-df57-4337-bc46-e2fe453919e6	0.00
TST	SO10001	001	CUST003	IRT-2024-015	2026-01-15	2026-01-25	2026-02-10	TRY	30GÜN	DAP	KARGO	TR	ORD001	AUTH001	SALES01	1	1	INT-IRT-001	Aydınlatmalı tabela ve reklam panosu siparişi1	ACTIVE	admin	4	8dfb10cf-5422-4ea5-9868-5992b6171201	0.00
TST	SO10004	001	CUST006	PRO-INT-0224	2026-01-22	2026-02-05	2026-02-20	USD	60GÜN	CIP	HAVA	US	ORD004	AUTH004	SALES03	1	3	INT-PRO-001	International corporate signage order	ACTIVE	admin	1	45d8ddfa-2f6e-4ed2-b6f7-c591f2433cc1	0.00
TST	SO10005	001	CUST007	MB-4567-DB	2026-01-25	2026-02-03	2026-02-18	TRY	30GÜN	DDP	KARGO	TR	ORD005	AUTH005	SALES02	2	2	INT-MB-001	Büyük format dijital baskı ve laminasyon	ACTIVE	admin	1	5c94f1f9-cc04-4360-bdff-5f45b20ec548	0.00
TST	SO10009	001	CUST013	CT-2024-003	2026-01-30	2026-02-05	2026-02-12	TRY	PEŞİN	DAP	KARGO	TR	ORD009	AUTH009	SALES01	1	1	INT-CT-001	Paslanmaz çelik tabela ve montaj	ACTIVE	admin	2	3da09b6a-df57-4337-bc46-e2fe453919e7	0.00
TST	SO07211	001	CUST001	a	2026-01-31	2026-01-09	\N	TRY	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	ACTIVE	admin	1	1fe66466-c9a7-42d0-9ad8-b074ac8cafd5	0.00
TST	SO10012	001	CUST018	IBB-2024/156	2026-02-05	2026-02-20	2026-03-15	TRY	60GÜN	DDP	KARGO	TR	ORD012	AUTH012	SALES05	1	1	INT-IBB-001	Kamu hizmet binası tabelaları4	ACTIVE	admin	3	b8443d0c-dc75-4bf2-ae49-238d3a09b837	0.00
TST	SO05742	01	CUST018	1	2026-02-06	\N	\N	TRY	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	ACTIVE	admin	1	c5000508-163f-47be-84f8-09c515c7a8d4	0.00
TST	SO04476	01	CUST005	A001	2026-02-06	2026-03-01	\N	TRY	\N	\N	\N	\N	\N	ahmet	mehmet	\N	\N	\N	\N	ACTIVE	admin	4	ab3272da-6163-4f4f-ad74-edea6c0d46a4	1.00
\.
...
01	PART06002	\N	\N	\N	\N	\N	\N	\N	\N	\N	ADET	ADET	BASKILI ROZET	0.00	0.00	1.00	KDV01	STANDARD	SATIS	SALE	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-02-06	\N	1	8aea5062-4c01-4b0d-9894-399385a2d28c	M	P
01	PART00527	\N	\N	\N	\N	\N	\N	\N	\N	\N	ADET	ADET	ROZET	0.00	0.00	1.00	KDV01	STANDARD	SATIS	SALE	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-02-06	\N	1	4fd3dab8-f381-4b74-acb2-154042e0a34e	R	P
\.
...
--
-- Data for Name: prod_structure_head_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
01	AP-001	A	STANDARD	\N	2026-02-01	2026-02-07	2026-02-01	ACTIVE	System	2	8d2e17b1-c848-4681-8a79-193488d16daa
01	PART06002	A	STANDARD	\N	2020-01-01	2050-02-01	2026-02-06	ACTIVE	System	1	fbf0f54e-ee18-4fda-bd33-76fb2b644eb4
\.


--
-- Data for Name: prod_structure_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
01	AP-001	A	STANDARD	000	1	10	10	\N	\N	2026-02-01	\N	LED-001	ACTIVE	System	2	9a3b54aa-094d-4ab7-803d-e9ae09e6743a
01	AP-001	A	STANDARD	000	2	10	10	\N	\N	2026-02-05	\N	ACR-001	ACTIVE	System	2	768b3daa-db9f-4f37-a91b-d8e3dd3d15ad
01	AP-001	A	STANDARD	000	3	10	20	\N	\N	2026-02-05	\N	ACR-003	ACTIVE	System	2	f09956ff-032d-4a9a-8572-fdaee69e2cd6
01	AP-001	A	STANDARD	000	4	10	20	\N	\N	2026-02-05	\N	VIN-001	ACTIVE	System	2	5cc842c1-d473-4721-bd3f-438757dac480
01	PART06002	A	STANDARD	000	1	10	10	\N	\N	2026-02-06	\N	PART00527	ACTIVE	System	1	233dacf8-16c0-4f55-a1bb-2d9541263a55
\.
...
--
-- Data for Name: routing_head_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
TST	01	PART06002	A	STANDARD	2020-01-01	2050-01-01	\N	\N	2026-02-06	2026-02-06	c8efc837-9a8c-4c41-b6d6-46f9acdc3c7e
\.


--
-- Data for Name: routing_operation_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
TST	01	PART06002	A	STANDARD	10	BASKI PROSESİ	BASKI	1	1	BASKI	\N	\N	\N	HOUR	\N	2026-02-06	ad995f2a-7502-4f84-b6ca-571135a353ed
\.


--
-- Data for Name: shop_material_alloc_tab; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.shop_material_alloc_tab (order_no, line_item_no, part_no, contract, operation_no, create_date, qty_assigned, qty_issued, qty_per_assembly, qty_required, note_text, activity_seq, project_id, catch_qty_issued, qty_scrapped_component, rowversion, rowkey, rowstate) FROM stdin;
WO05047	1	AP-001	001	10	2026-02-05	1	\N	1	1	\N	\N	\N	\N	\N	1	149ad3c7-99e8-4260-9d39-28b58b94fd43	Active
WO04627	1	LED-001	01	10	2026-02-06	10	10	1	10	Satış Siparişi: SO05742	\N	\N	\N	\N	2	8f72517f-7305-4c64-9d95-8408ec3307e7	Active
WO04627	2	ACR-001	01	10	2026-02-06	10	10	1	10	Satış Siparişi: SO05742	\N	\N	\N	\N	2	9dc5ca8d-5149-45e0-845c-f559623a7036	Active
WO04627	3	ACR-003	01	20	2026-02-06	10	10	1	10	Satış Siparişi: SO05742	\N	\N	\N	\N	2	bfd481d5-c23b-4836-89c7-98dc1bc5fbdd	Active
WO04627	4	VIN-001	01	20	2026-02-06	10	10	1	10	Satış Siparişi: SO05742	\N	\N	\N	\N	2	a4be8ea4-054b-4549-99b7-886ab08ee4ce	Active
WO07364	1	LED-001	01	10	2026-02-05	20	20	2	20	\N	\N	\N	\N	\N	6	2de6db4c-919f-40ec-80cf-ca8615ca58ec	Active
WO07364	2	ACR-001	01	10	2026-02-05	10	10	1	10	\N	\N	\N	\N	\N	7	575585ed-3b36-4c8c-8b70-c38590096f51	Active
WO07364	3	ACR-003	01	20	2026-02-05	10	10	1	10	\N	\N	\N	\N	\N	6	ea146122-8f88-4229-a77e-9919a5d792c0	Active
WO07364	4	VIN-001	01	20	2026-02-05	10	10	1	10	\N	\N	\N	\N	\N	6	f5867c6b-cd03-45e6-8f51-1bb05a0313d8	Active
WO07524	1	PART00527	01	10	2026-02-06	1000	1000	1	1000	Satış Siparişi: SO04476	\N	\N	\N	\N	7	b94014f2-8737-41c9-8581-68c34787608c	Active
WO07145	1	LED-001	01	10	2026-02-07	0	0	1	1	\N	\N	\N	\N	\N	1	f7b1537f-68c9-4e77-94eb-fad17531ee88	Active
WO07145	2	ACR-001	01	10	2026-02-07	0	0	1	1	\N	\N	\N	\N	\N	1	55abdf14-e6e4-4288-bcfd-e486dac52823	Active
WO07145	3	ACR-003	01	20	2026-02-07	0	0	1	1	\N	\N	\N	\N	\N	1	a0486d16-ffa5-4605-be31-e37aa29886c7	Active
WO07145	4	VIN-001	01	20	2026-02-07	0	0	1	1	\N	\N	\N	\N	\N	1	0ed73072-908b-4923-b11f-610da70ffd8e	Active
\.


--
-- Data for Name: shop_ord_tab; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.shop_ord_tab (order_no, order_code, contract, part_no, revised_start_date, revised_due_date, need_date, complete_date, revised_qty_due, qty_complete, operation_scrapped, note_text, customer_order_no, customer_line_no, customer_rel_no, customer_line_item_no, customer_no, project_id, activity_seq, owning_customer_no, created_by, rowversion, rowkey, rowstate, planner_id) FROM stdin;
WO05047	01	001	AP-001	2026-02-04	2026-02-04	\N	\N	1	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	admin	1	ffd1a5ce-06c3-4bc9-904c-7b49f0b40d39	Released	\N
WO04627	001	01	AP-001	2026-02-06	2026-02-06	2026-02-06	\N	10	0	\N	Satış Siparişi: SO05742, Satır: 1	SO05742	\N	\N	\N	\N	\N	\N	\N	admin	2	f8250cf1-b150-4f60-9892-bba38c294a1b	Closed	\N
WO07364	01	01	AP-001	2026-02-05	2026-02-05	\N	\N	10	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	admin	6	c1a10d8f-37e1-4017-92a3-cabeff79d02f	Closed	\N
WO07524	001	01	PART06002	2026-02-06	2026-02-06	2026-02-06	\N	1000	1000	\N	Satış Siparişi: SO04476, Satır: 1	SO04476	\N	\N	\N	\N	\N	\N	\N	admin	5	bd355c1a-4a17-49b3-863d-70c387238277	Closed	\N
WO07145	01	01	AP-001	2026-02-07	2026-02-07	\N	\N	1	0	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	admin	1	bfe43283-4e00-4daf-af82-bef19a0856f3	Released	\N
\.
...
--
-- Data for Name: work_center_tab; Type: TABLE DATA; Schema: public; Owner: -
--
...
TST	01	BASKI	BASKI	BASKI	BASKI	BASKI	BASKI	2026-02-06	2026-02-06	77001876-a90f-4b9e-898b-02d3ba540f82	Active
\.
...
--
-- Name: company_tab PK_company_tab; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customer_info PK_customer_info; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: inventory_part PK_inventory_part; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: company_site_tab company_contract_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: company_site_tab contract_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customer_order_line_tab customer_order_line_tab_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customer_order_tab customer_order_tab_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: currency_rate_tab pk_currency_rate; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.currency_rate_tab
    ADD CONSTRAINT pk_currency_rate PRIMARY KEY (company, currency_code, valid_from, currency_type);


--
-- Name: prod_structure_tab pk_prod_structure; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: prod_structure_head_tab pk_prod_structure_head; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shop_material_alloc_tab pk_shop_material_alloc_tab; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shop_material_alloc_tab
    ADD CONSTRAINT pk_shop_material_alloc_tab PRIMARY KEY (contract, order_no, line_item_no, part_no);


--
-- Name: shop_ord_tab pk_shop_ord_tab; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shop_ord_tab
    ADD CONSTRAINT pk_shop_ord_tab PRIMARY KEY (contract, order_no, order_code, part_no);


--
-- Name: routing_head_tab routing_head_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: routing_operation_tab routing_operation_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: work_center_tab uq_work_center; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX idx_currency_rate_code ON public.currency_rate_tab USING btree (currency_code);


--
-- Name: idx_currency_rate_company; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_currency_rate_company ON public.currency_rate_tab USING btree (company);
...
CREATE INDEX idx_currency_rate_date ON public.currency_rate_tab USING btree (valid_from);


--
-- Name: idx_currency_rate_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_currency_rate_type ON public.currency_rate_tab USING btree (currency_type);


--
-- Name: idx_customer_order_line_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: customer_order_line_tab customer_order_line_tab_company_order_no_contract_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: prod_structure_tab fk_prod_structure_head; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict TRHBh15b0IxaTrZg0UFuxfkiHIo2dhzp0A1hD9ceoGfavdUw7OOva7m5qKftAHc
